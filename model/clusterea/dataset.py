...
class EAData:
    ...
    def process_one_graph(rel_pos: str):
        ...
        return EAData.process_one_graph_from_triples(triples)
    
    @staticmethod 
    def process_one_graph_from_triples(input_triples):
        triples, rel_idx, ent_idx = [], {}, {}
        for now in input_triples:
        ...
        for links_pos in links_list:
            ...
            with codecs.open(links_pos, "r", 'utf-8') as f:
                for line in f.readlines():
                    ...
                    tuples_from_files.append(now)
        return EAData.process_link_from_tuples(tuples_from_files, ent1, ent2, filter_link=filter_link)
    
    @staticmethod
    def process_link_from_tuples(link_tuples, ent1, ent2, filter_link=True):
        link = []
        link1 = set()
        link2 = set()
...
class InMemoryEAData(EAData):
    ...
    def __init__(self, triples1, triples2, ent_links, train_count = None, semi_links = None, train_ratio=None, **kwargs):
        ...
        self.index2ent1 = {v: k for k, v in self.ent1.items()}
